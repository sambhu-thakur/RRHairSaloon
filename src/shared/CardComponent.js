...
function  CardComponent () {
  ...
  <div className="col shadow-lg p-1 mb-1 bg-white rounded  ">
    <div className="card ">
       <img src="public/assets/images/style1.jpg" class="card-img-top" alt="..." height={350}/>
   
    </div>
  </div>
  <div className="col  shadow-lg p-1 mb-1 bg-white rounded  ">
    <div className="card ">
      <img src="public/assets/images/Haircut.jpg" class="card-img-top" alt="..." height={350}/>
   
    </div>
  </div>
  <div className="col shadow-lg p-1 mb-1 bg-white rounded  ">
    <div className="card ">
       <img src="public/assets/images/Fade-Hairstyles.jpg" class="card-img-top" alt="..." height={350}/>
